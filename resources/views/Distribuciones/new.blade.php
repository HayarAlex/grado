                  ...
                  <table id="order-listing" class="table table-striped">
                      ...
                      <tbody>
                          ...
                          <tr>
                            ...
                            @endif
                            <td style="width: 10px">
                                <center><a class="text-center" style="color:#403969" href="{{ url('/Distribucion/Detalle/'.$ped->dis_id) }}"><i class="mdi mdi-arrow-right-bold-circle"></i></a></center>
                            </td>
                          </tr>
                          @endforeach
                      </tbody>
