...
<div class="row">
  <div class="col-12 grid-margin">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Actualizar Datos Administrador</h4>
        <form class="form-sample" action="{{ route('user.update',Crypt::encrypt($user->id)) }}" method="POST">
          @csrf
          @method('PUT')
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <div class="col-sm-12">
                  ...
                  <input id="pat" type="text" name="name" class="form-control" placeholder="Ingrese nombre" value="{{ $user->name }}"/>
                  @if($errors->has('name'))
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <div class="col-sm-12">
                  ...
                  <input id="pat" type="text" name="paternal" class="form-control" placeholder="Ingrese paterno" value="{{ $user->paternal }}" />
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <div class="col-sm-12">
                  ...
                  <input id="pat" type="text" name="maternal" class="form-control" placeholder="Ingrese materno" value="{{ $user->maternal }}"/>
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <div class="col-sm-12">
                  ...
                  <input id="pat" type="text" name="address" class="form-control" placeholder="Ingrese dirección" value="{{ $user->address }}" />
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <div class="col-sm-12">
                  ...
                  <input id="pat" type="email" name="email" class="form-control" placeholder="Ingrese email" value="{{ $user->email }}"/>
                  @if($errors->has('email'))
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <div class="col-sm-12">
                  ...
                  <input id="pat" type="text" name="phone" class="form-control" placeholder="Ingrese telefono" value="{{ $user->phone }}"/>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <div class="col-sm-12">
                  ...
                  <input id="pat" type="text" name="ci" class="form-control" placeholder="Ingrese ci" value="{{ $user->ci }}"/>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div style="text-align:right;margin-top: 35px">
                ...
                <a class="btn btn-light font-weight-medium auth-form-btn" href="{{ route('user.index') }}">Cancelar</a>
              </div>
            </div>
          </div>          
        </form>
