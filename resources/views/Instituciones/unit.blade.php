                      ...
                      <tbody>
                        @foreach($unidades as $unid)
                          <tr>
                            ...
                            <td class="text-center"><center><a class="text-center" style="color:#403969" href="{{ url('/Institucional/'.$unid->uneg_id) }}"><i class="mdi mdi-arrow-right-bold-circle"></i></a></center></td>
                          </tr>
                        @endforeach
                      </tbody>
                  </table><br>
