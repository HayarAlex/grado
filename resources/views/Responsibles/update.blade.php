            ...
            <div class="col-md-4">
              <div class="form-group row">
                <div class="col-sm-12">
                  ...
                  <input id="pat" type="text" name="name" class="form-control" placeholder="Ingrese nombre" value="{{ $responsible->name }}"/>
                  @if($errors->has('name'))
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <div class="col-sm-12">
                  ...
                  <input id="pat" type="text" name="paternal" class="form-control" placeholder="Ingrese paterno" value="{{ $responsible->paternal }}" />
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <div class="col-sm-12">
                  ...
                  <input id="pat" type="text" name="maternal" class="form-control" placeholder="Ingrese materno" value="{{ $responsible->maternal }}"/>
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <div class="col-sm-12">
                  ...
                  <input id="pat" type="text" name="address" class="form-control" placeholder="Ingrese dirección" value="{{ $responsible->address }}" />
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <div class="col-sm-12">
                  ...
                  <input id="pat" type="email" name="email" class="form-control" placeholder="Ingrese email" value="{{ $responsible->email }}"/>
                  @if($errors->has('email'))
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <div class="col-sm-12">
                  ...
                  <input id="pat" type="text" name="phone" class="form-control" placeholder="Ingrese telefono" value="{{ $responsible->phone }}"/>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <div class="col-sm-12">
                  ...
                  <input id="pat" type="email" name="email" class="form-control" placeholder="Ingrese email" value="{{ $responsible->ci }}" disabled/>
                </div>
              </div>
            </div>
            <div class="col-md-4">
